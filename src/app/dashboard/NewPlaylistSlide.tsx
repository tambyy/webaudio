              ...
              <div className="flex-1 flex flex-col p-2 overflow-hidden">
                ...
                <div className="flex-1 flex flex-col overflow-hidden hidden">
                  ...
                  <div className="w-full text-sm font-medium text-gray-400 h-8 flex flex-row rounded border border-gray-300">
                    ...
                    />
                    {/* All tags */}
                    <select className="flex-1 h-full px-3 bg-transparent">
                  ...
                  {/* Songs list */}
                  <div className="flex-1 flex flex-col gap-1 pt-2 overflow-auto">
                    {songs.map((song) => (
                      <Song
                        key={song.id}
                        song={song}
                  ...
                  <div className="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div className="w-full text-sm font-medium text-gray-400 h-8 flex flex-row rounded border border-gray-300">
                      ...
                      <input
                        className="w-40 h-full bg-transparent px-3 border-r border-gray-300"
                        placeholder="Rechercher dans ma"
                        onChange={(e) => setFilterSongKeyword(e.target.value)}
                      />
                      {/* All tags */}
                      <select
                    ...
                    >
                      {filteredSongs.map((song) => (
                        <Song
                          ...
                          isSelected={findPlaylistSong(song)}
                          onChange={(e) =>
                            e ? addPlaylistSong(song) : removePlaylistSong(song)
                          }
                        />
                      ))}
                    </div>
